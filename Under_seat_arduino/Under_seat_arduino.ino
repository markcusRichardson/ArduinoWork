...
delay(500);
    ...
    for (int i = 0; i < NUM_SEGMENTS; i++) {
      ...
      // Serial.print(i);
      // Serial.print(": ");
      Serial.print(segments[i] + radarReading);
    }
  ...
  if (radarResponse[0] == 0x55 ) {
    ...
    switch (motionState) {
      case 0x02:
        ...
        radarReading = "Approaching Detected.";
        break;
      case 0x03:
        detected == true;
        // Serial.println("Departing Detected.");
        radarReading = "Departing Detected.";
        break;
      case 0x04:
        detected == true;
        // Serial.println("Sustained approach.");
        radarReading = "Sustained approach.";
        break;
      case 0x05:
        detected == true;
        // Serial.println("Sustained away.");
        radarReading = "Sustained away.";
        break;
        default:
        detected == false;
        radarReading = "";
